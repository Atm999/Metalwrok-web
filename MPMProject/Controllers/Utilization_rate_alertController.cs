...
namespace MPMProject.Controllers
{
    public class Utilization_rate_alertController : BaseController
    {
        ...
        {
            url = url + "api/v1/configuration/andon/utilization_rate_alert_detail";
        ...
        {
            url = url + "api/v1/configuration/andon/utilization_rate_alert";
        ...
        {
            url = url + "api/v1/configuration/andon/utilization_rate_alert?id=" + ec.id.ToString();
