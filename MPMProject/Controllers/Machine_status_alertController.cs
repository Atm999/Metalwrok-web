...
namespace MPMProject.Controllers
{
    public class Machine_status_alertController : BaseController
    {
        ...
        {
            url = url + "api/v1/configuration/andon/machine_status_alert_detail";
        ...
        {
            url = url + "api/v1/configuration/andon/machine_status_alert";
        ...
        {
            url = url + "api/v1/configuration/andon/machine_status_alert?id=" + ec.id.ToString();
